...
function loadQuestion() {
  ...
  const q = getRandomMultiplication();
  questions.push(q);
...
function showResults() {
  ...
  if (score === 10) {
    feedback.innerHTML = "🌟 Perfect score! You're a multiplication master!";
  } else if (score >= 7) {
    feedback.innerHTML = "👍 Great job! You're doing awesome!";
  } else if (score >= 4) {
    feedback.innerHTML = "😊 You're getting there. Keep practicing!";
  } else {
    feedback.innerHTML = "💡 Keep it up! Practice makes perfect!";
  }
}

function goBack() {
  window.location.href = "menu.html"; // Or your actual menu page path
}
